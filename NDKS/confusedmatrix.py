...
parser.add_argument('-data', metavar='DIR', default='./dataset/FER-2013',
                    help='path to dataset')
parser.add_argument('-a', '--arch', metavar='ARCH', default="shufflenet_v2_x1_0",
                    help='model architecture: ' +
                        ' | '.join("shufflenet_v2_x1_0"))
...
parser.add_argument('--lr', '--learning-rate', default=30.0, type=float,
...
parser.add_argument('--pretrained', default='./0.05/checkpoint_0199.pth.tar', type=str,
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = shufflenet.shufflenet_v2_x1_0()
    ...
    # init the fc layer
    model.fc = nn.Linear(model.fc.weight.size(1),7)
    ...
    with torch.no_grad():
        ...
        for i, (images, target) in enumerate(val_loader):
            ...
            if epoch == 99:
                ...
                labels_np = target.cpu().numpy()  # array([0,5,0,6,2,...],dtype=int64)
...
class DrawConfusionMatrix:
    ...
    def drawMatrix(self):
        ...
        plt.colorbar()  # 色条
        plt.savefig('./img/ConfusionMatrix.png', bbox_inches='tight')  # bbox_inches='tight'可确保标签信息显示全
        plt.show()
